...
class JNILinkage : public PrivateLinkage
    ...
    */
   void buildJNIArgs(TR::Node *callNode, TR::RegisterDependencyConditions *deps, bool passThread, bool passReceiver);

   /**
    * @brief Builds register dependencies for the return register
    * @param[in] callNode : caller node
    * @param[in] deps : register dependency conditions
    * @return register holding return value
    */
   TR::Register *buildReturnDependencies(TR::Node *callNode, TR::RegisterDependencyConditions *deps);
    ...
    */
   TR::Instruction *generateMethodDispatch(TR::Node *callNode, bool isJNIGCPoint, TR::RegisterDependencyConditions *deps, TR::Register *scratchReg, uintptrj_t targetAddress);
